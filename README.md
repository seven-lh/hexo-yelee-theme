...
Theme **Yelee** relies on [Hexo-Theme-Yilia][1], thanks for the author [Litten][2]. Fix some bugs, change lots of styles, add several features. And then I made the theme. Yelee is mainly designed for fluent text reading. I change styles and add functions, meanwhile, try hard to keep this theme simple, stupid and clear. Theme DEMO: [lollipoppp's Blog][6]

> M-Hexo-Blog [Commits][3]; hexo-yelee-theme [Commits][4]; [建站日志][5]

本主题 **Yelee** 基于主题 [Hexo-Theme-Yilia][1] 修改而来，在此感谢原作者 [Litten][2]。修复了一些 bugs，改变了大量的样式，添加了不少特性。对原主题百般折腾后，发觉变动越来越大，索性就发布个新主题了，主题随我微博名叫 "Yelee" 。个人喜欢简洁的样式，重视内容的浏览，同时希望博客作为个人网站，能稍微凸显出博主个性。各种修改折腾大抵基于以上考虑。主题实际效果，请访问本人博客查看：[lollipoppp's Blog][6]

[1]: https://github.com/litten/hexo-theme-yilia
[2]: http://litten.github.io/ "Litten的博客"
[3]: https://github.com/lollipoppp/M-Hexo-Blog/commits/master
[4]: https://github.com/lollipoppp/hexo-yelee-theme/commits/master
[5]: http://blog.aimer.love//2015/08/20/blog-building/ "个人博客站点建设历程"
[6]: http://blog.aimer.love/
...
```
git clone https://github.com/lollipoppp/hexo-yelee-theme.git themes/yelee
```
...
> Post with several categories 文章设置多个分类后的问题 [issue#4](https://github.com/lollipoppp/hexo-yelee-theme/issues/4)

> - [让 Hexo 自动生成 Tag Cloud 标签云页面](http://lollipoppp.xyz/2015/10/25/hexo-tag-cloud/)
...
> - [保留使用 Yilia 主题时的多说用户评论](https://github.com/lollipoppp/hexo-yelee-theme/issues/1)

> - [多说样式折腾记录 — 添加 UA 浏览器标识、旋转头像等](http://lollipoppp.xyz/2015/09/29/duoshuo-style/)
...
> - [在 Hexo 中创建匹配主题的404页面](http://lollipoppp.xyz/2015/10/16/hexo-404-page/)
